...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    104c:	ff 36                	push   (%esi)
    104e:	e8 27 02 00 00       	call   127a <mkdir>
    ...
    105d:	ff 36                	push   (%esi)
    105f:	68 3b 16 00 00       	push   $0x163b
    1064:	6a 02                	push   $0x2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1328:	0f b6 92 b8 16 00 00 	movzbl 0x16b8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    13f5:	ff 24 85 60 16 00 00 	jmp    *0x1660(,%eax,4)
        printint(fd, *ap, 10, 1);
    ...
    145a:	75 15                	jne    1471 <printf+0xfa>
          s = "(null)";
    145c:	be 57 16 00 00       	mov    $0x1657,%esi
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    14e9:	a1 64 19 00 00       	mov    0x1964,%eax
  ...
  freep = p;
    1527:	a3 64 19 00 00       	mov    %eax,0x1964
}
    152c:	5b                   	pop    %ebx
    152d:	5e                   	pop    %esi
    152e:	5f                   	pop    %edi
...
morecore(uint nu)
{
  ...
  return freep;
    1589:	a1 64 19 00 00       	mov    0x1964,%eax
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    15b0:	8b 0d 64 19 00 00    	mov    0x1964,%ecx
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    base.s.ptr = freep = prevp = &base;
    15be:	c7 05 64 19 00 00 68 	movl   $0x1968,0x1964
    15c5:	19 00 00 
    15c8:	c7 05 68 19 00 00 68 	movl   $0x1968,0x1968
    15cf:	19 00 00 
    base.s.size = 0;
    15d2:	c7 05 6c 19 00 00 00 	movl   $0x0,0x196c
    15d9:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    15dc:	b9 68 19 00 00       	mov    $0x1968,%ecx
    ...
    15ed:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    15f0:	89 0d 64 19 00 00    	mov    %ecx,0x1964
      return (void*)(p + 1);
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    160f:	39 05 64 19 00 00    	cmp    %eax,0x1964
